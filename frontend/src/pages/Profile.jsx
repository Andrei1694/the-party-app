    ...
    return (
        <div className="bg-cusens-bg font-display min-h-screen flex items-start justify-center p-4">
            <div className="w-full max-w-md bg-cusens-surface rounded-3xl shadow-xl overflow-hidden border border-gray-100 relative flex flex-col">
                ...
                {/* Stich AI Assistant FAB */}
                <div className="absolute bottom-6 right-6 z-20">
                    <button className="w-14 h-14 bg-cusens-primary rounded-full flex items-center justify-center text-white shadow-lg hover:bg-cusens-primary-hover transition-all duration-200 transform hover:scale-105">
