...
const Register = () => {
  ...
  return (
    <div className="bg-cusens-bg font-display min-h-screen flex items-start sm:items-center justify-center sm:px-4 sm:py-6">
      <div className="w-full min-h-screen bg-cusens-bg flex flex-col relative overflow-hidden sm:min-h-0 sm:max-w-2xl sm:rounded-3xl sm:border sm:border-cusens-border sm:bg-cusens-surface sm:shadow-xl">
        <header className="px-4 py-4 sm:px-6 md:px-8 flex items-center justify-between sticky top-0 z-10 bg-cusens-bg/95 sm:bg-cusens-surface/95 backdrop-blur-md">
          <button
        ...
        <main className="flex-1 overflow-y-auto px-4 pb-36 sm:px-6 sm:pb-8 md:px-8">
        ...
        <div className="absolute bottom-0 left-0 z-20 w-full border-t border-cusens-border bg-cusens-bg/95 px-4 pt-4 pb-[max(1rem,env(safe-area-inset-bottom))] backdrop-blur-md sm:static sm:bg-transparent sm:px-6 sm:py-6 sm:backdrop-blur-none md:px-8">
