        ...
        <div className="bg-cusens-bg font-display min-h-screen flex items-start justify-center p-4">
            <div className="w-full max-w-md bg-cusens-surface rounded-3xl shadow-xl overflow-hidden border border-cusens-border relative flex flex-col">
                ...
                <header className="px-6 py-4 flex items-center justify-between sticky top-0 z-10 bg-cusens-surface/95 backdrop-blur-md">
                    ...
                    <h1 className="text-base font-bold leading-tight tracking-tight flex-1 text-center text-cusens-text-primary">
                ...
                <main className="flex-1 overflow-y-auto px-6 pb-24">
                    ...
                    <div className="flex flex-col items-center gap-4 pt-2">
                        ...
                        <div className="flex flex-col items-center justify-center">
                            <p className="text-cusens-text-primary text-xl font-bold leading-tight text-center">Jane Doe</p>
